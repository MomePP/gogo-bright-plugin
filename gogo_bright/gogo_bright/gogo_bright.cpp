...
bool GOGO_BRIGHT::setOutputPower(int power)
{
    ...
    return wireWriteDataByte(CMD_MOTOR_PWR, power);
}

bool GOGO_BRIGHT::turnOutputON(void)
{
    return wireWriteDataByte(CMD_MOTOR_ON, 1);
}
bool GOGO_BRIGHT::turnOutputOFF(void)
{
    return wireWriteDataByte(CMD_MOTOR_OFF, 0);
}

bool GOGO_BRIGHT::turnOutputThisWay(void)
{
    return wireWriteDataByte(CMD_MOTOR_CW, 1);
}

bool GOGO_BRIGHT::turnOutputThatWay(void)
{
    return wireWriteDataByte(CMD_MOTOR_CCW, 0);
}

bool GOGO_BRIGHT::toggleOutputWay(void)
{
    return wireWriteDataByte(CMD_MOTOR_RD, 1);
}
...
bool GOGO_BRIGHT::setServoHead(int head_angle)
{
    ...
    return wireWriteDataByte(CMD_SERVO_SETH, head_angle);
}
...
bool GOGO_BRIGHT::turnServoCW(int cw_angle)
{
    ...
    return wireWriteDataByte(CMD_SERVO_CW, cw_angle);
}
...
bool GOGO_BRIGHT::turnServoCCW(int ccw_angle)
{
    ...
    return wireWriteDataByte(CMD_SERVO_CCW, ccw_angle);
}
...
bool GOGO_BRIGHT::wireWriteDataByte(uint8_t reg, uint8_t val)
{
	...
	return (i2c->write(channel, address, data, 2) == ESP_OK);
}
